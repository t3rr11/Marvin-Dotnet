...
public class MemberScanner : EntityScannerBase<GroupMember, ClanUpdateContext>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ValueTask.FromResult(profileResponse!.HasPublicRecords());
    }
    ...
    [ScanStep(nameof(PerformBroadcastedProfileUpdate), 6)]
    public async ValueTask<bool> PerformBroadcastedProfileUpdate(
        GroupMember groupMember,
        ClanUpdateContext context,
        ScanContext scanContext,
        CancellationToken cancellationToken)
    {
        ...
        if (updateContext.ShouldScanSilently)
        {
        ...
        {
            PerformBroadcastedProfileUpdateAsync(
                destinyProfile,
                updateContext,
                profileResponse,
                context.BroadcastsConfigs,
                cancellationToken);
        }
    ...
    [ScanStep(nameof(UpdateDestinyProfileInDb), 7, true)]
    public async ValueTask<bool> UpdateDestinyProfileInDb(
        GroupMember groupMember,
        ClanUpdateContext context,
        ScanContext scanContext,
        CancellationToken cancellationToken)
    ...
    private void PerformBroadcastedProfileUpdateAsync(
        DestinyProfile destinyProfile,
        ProfileUpdateContext profileUpdateContext,
        DestinyProfileResponse destinyProfileResponse,
        ...
        CancellationToken cancellationToken)
    {
        ...
        _collectibleProcessor.UpdateAndReportCollectibles(
            broadcastsConfigs,
            destinyProfile,
            destinyProfileResponse,
            profileUpdateContext.TrackedProfileCollectibleHashes,
        ...
        _recordProcessor.UpdateAndReportRecords(
            broadcastsConfigs,
            destinyProfile,
            profileUpdateContext.TitleHashes,
            profileUpdateContext.TrackedProfileRecordHashes,
            destinyProfileResponse,
            cancellationToken);
