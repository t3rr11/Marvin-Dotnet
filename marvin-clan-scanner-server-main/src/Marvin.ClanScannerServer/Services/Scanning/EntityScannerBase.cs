...
public abstract class EntityScannerBase<TInput, TContext>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        for (var i = 0; i < _steps.Length; i++)
        {
            ...
            try
            {
                ...
                var executionResult = await nextStep.Delegate(input, context, scanContext, cancellationToken);
    ...
    protected void Initialize()
    {
        ...
        {
            var delegateFunc =
                (Func<TInput, TContext, ScanContext, CancellationToken, ValueTask<bool>>)Delegate.CreateDelegate(
                    typeof(Func<TInput, TContext, ScanContext, CancellationToken, ValueTask<bool>>),
                    this,
                    step.Key);
